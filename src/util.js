...
const MiddleType= (dataPack) => {
  ...
  function west(pw5w6, pc5w5){
    if(pw5w6<3.7 && pc5w5 >=3){
      return 4;
    }
    else{
      return 0;
...
function getData(){
  ...
  let startTime = '2017-10-28 12:00:00';
  let endTime = '2017-11-01 12:00:00';
...
function resolveData(list,wind10m){ //list -> 气压序列，data2->u10m,v10m
  ...
  for(let i = 0; i<totalPoints;i++){
    pointsList.push(list.slice(i, (i+1)*pointLength));
  }
